  ...
  exampleData = [
    {
      ...
      tags_url:
        'https://api.github.com/repos/TaylorShane/BrewBuddy-Android/tags',
      teams_url:
...
interface exampleData {
  ...
  name: 'BrewBuddy-Android';
  node_id: 'MDEwOlJlcG9zaXRvcnk5MTk5MDE0OQ==';
  notifications_url: 'https://api.github.com/repos/TaylorShane/BrewBuddy-Android/notifications{?since,all,participating}';
  open_issues: 0;
  open_issues_count: 0;
  owner: {
    avatar_url: 'https://avatars0.githubusercontent.com/u/26348898?v=4';
