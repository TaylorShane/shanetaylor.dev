...
export class WorkExamplesComponent implements OnInit {
  ...
  public readonly graphyInfo: ProjectData = new ProjectData(
    ...
    [
      '../../assets/img/graphy/ScreenShots/Screenshot_1500145891.jpg',
      '../../assets/img/graphy/ScreenShots/Screenshot_1500145896.jpg',
      '../../assets/img/graphy/ScreenShots/Screenshot_1500145900.jpg',
      '../../assets/img/graphy/ScreenShots/Screenshot_1500145905.jpg',
      '../../assets/img/graphy/ScreenShots/Screenshot_1500149162.jpg',
      '../../assets/img/graphy/ScreenShots/Screenshot_1500149174.jpg',
    ],
    'Graphy',
  ...
  public readonly thgInfo: ProjectData = new ProjectData(
    ...
    [
      '../../assets/img/THG/Screenshot_1510861783.jpg',
      '../../assets/img/THG/Screenshot_1510861989.jpg',
      '../../assets/img/THG/Screenshot_1510861997.jpg',
    ],
  ...
  public readonly spottertInfo: ProjectData = new ProjectData(
    ...
    [
      '../../assets/img/spotter/signin_register.jpg',
      '../../assets/img/spotter/signin.jpg',
      '../../assets/img/spotter/registration.jpg',
      '../../assets/img/spotter/meal_calories_total.jpg',
      '../../assets/img/spotter/user_profile.jpg',
    ],
    'Spotter',
    undefined,
  ...
  public readonly brewBuddyInfo: ProjectData = new ProjectData(
    ...
    [
      '../../assets/img/brewbuddy/Screenshot_1507672646.jpg',
      '../../assets/img/brewbuddy/Screenshot_1507672671.jpg',
      '../../assets/img/brewbuddy/Screenshot_1507672664.jpg',
    ],
    'BrewBuddy',
    undefined,
  ...
  public readonly sweDocInfo: ProjectData = new ProjectData(
    ...
    [
      '../../assets/img/pixelhero/add.jpg',
      '../../assets/img/pixelhero/srs.jpg',
    ],
  ...
  public readonly mdbmInfo: ProjectData = new ProjectData(
    ...
    [
      '../../assets/img/mdbm/mdbm-data-dictionary.jpg',
      '../../assets/img/mdbm/mdbm-er-diagram.jpg',
    ],
    'SQL Database',
    undefined,
